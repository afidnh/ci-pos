            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                   <?php $h=$this->session->userdata('akses'); ?>
                    ...
                    <!--dropdown-->
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" title="Transaksi"><span class="fa fa-shopping-bag" aria-hidden="true"></span> Master Barang</a>
                        <ul class="dropdown-menu">
                            <li>
                                <a href="<?php echo base_url().'admin/barang'?>"><span class="fa fa-cubes"></span>Barang</a>
                            </li>
                            <li>
                                <a href="<?php echo base_url().'admin/kategori'?>"><span class="fa fa-cubes"></span>Kategori</a>
                            </li>
                        </ul>
                    </li>
                    <!--ending dropdown-->
                   ...
                   <!--  <?php if($h=='2'){ ?> 
                    ...
                    <?php }?> -->
                    <li>
                        <a href="<?php echo base_url().'admin/pengguna'?>"><span class="fa fa-user"></span> User</a>
                    </li>
                     <li>
