        ...
        <div class="row">
            ...
            <table class="table table-bordered table-condensed" style="font-size:11px;" id="mydata">
                ...
                ?>                    
                        ...
                        <td style="text-align:right;"><?php echo 'Rp '.number_format($harjul_agen);?></td>
                        ...
                        <td style="text-align:center;">
                            ...
                            <a class="btn btn-xs btn-danger" href="#modalHapusPelanggan<?php echo $id?>" data-toggle="modal" title="Hapus"><span class="fa fa-close"></span></a>
                        </td>
                    </tr>
                <?php endforeach;?>
                </tbody>
        ...
        <div class="modal fade" id="largeModal" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
            ...
            <form class="form-horizontal" method="post" action="<?php echo base_url().'admin/barang/tambah_barang'?>">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label class="control-label col-xs-3" >Harga (Pelanggan)</label>
                        <div class="col-xs-9">
                            <input name="harjul" class="harjul form-control" type="text" placeholder="Harga Jual Pelanggan..." style="width:335px;">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label class="control-label col-xs-3" >Harga (Sub Agen)</label>
                        <div class="col-xs-9">
                            <input name="harjul_agen" class="harjul form-control" type="text" placeholder="Harga Jual Sub Agen..." style="width:335px;">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-9">
                            <input name="size" class="form-control" type="text" placeholder="Ukuran Barang" style="width:335px;">
                        </div>
                    </div>
                ...
                <div id="modalEditPelanggan<?php echo $id?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
                    ...
                    <form class="form-horizontal" method="post" action="<?php echo base_url().'admin/barang/edit_barang'?>">
                        ...
                        <div class="form-group">
                            <label class="control-label col-xs-3" >Harga (Sub Agen)</label>
                            <div class="col-xs-9">
                                <input name="harjul_agen" class="harjul form-control" type="text" value="<?php echo $harjul_agen;?>" placeholder="Harga Jual Agen..." style="width:335px;" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="control-label col-xs-3" >Size</label>
                            <div class="col-xs-9">
                                <input name="size" class="form-control" type="text" value="<?php echo $size;?>" placeholder="Ukuran Barang" style="width:335px;" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-xs-3" >Status</label>
                            <div class="col-xs-9">
                                <select name="status" class="selectpicker show-tick form-control" data-live-search="true" data-width="80%" required>
                                    <?php
                                        if ($status == 0) {
                                           echo '<option value="0" selected>Ready</option>
                                                <option value="1">PO</option>';
                                        }else{
                                            echo '<option value="0">Ready</option>
