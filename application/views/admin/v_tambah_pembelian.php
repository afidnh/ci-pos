...
<body>
   ...
   ?>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
            <form action="<?php echo base_url().'admin/pembelian/add_to_cart'?>" method="post"><hr/>
            <table>
                <tr>
                    <a href="#" data-toggle="modal" data-target="#largeModal"  class="btn btn-danger btn-lg"><span class="fa fa-cubes"></span> Tambah Barang</a>
                </tr>
            </table>
             </form>
                  ...
                  <table class="table table-bordered table-condensed" style="font-size:11px;" id="mydata">
                    ...
                    ?>
                        <tr>
                            ...
                            <td style="text-align:center; width:100px;"><?php echo $id;?></td>
                            <td style="width:200px; margin-right:5px;"><?php echo $nm;?></td>
                            <td style="width:70px; margin-right:5px;"><?php echo $satuan;?></td>
                            <td>
                                <input type="text" name="harpok" value="<?php echo $harpok;?>" style="width:100px;margin-right:5px;" class="form-control input-sm" required>
                            </td>
                            <td>
                                <input type="text" name="harjul" value="<?php echo $harjul;?>" style="width:90px;margin-right:5px;" class="form-control input-sm" required>
                            </td>
                            <td>
                                <input type="text" name="jumlah" id="jumlah" class="form-control input-sm" style="width:70px;margin-right:5px;" required>
                            </td>
                            <input type="hidden" name="kode_brg" value="<?php echo $a['barang_id'];?>" style="width:100px;" class="form-control input-sm" readonly>
